!function() {
  ...
  function t(t, i) {
    ...
    return this.el = document.querySelector(t), this.settings = e.extend(s, i), this.body = document.querySelector('body'), this.sections = this.el.querySelectorAll(this.settings.section), this.init(), this;
  }
  ...
  var e = {
    ...
    setVendor: function(t, e, i) {
      t.style[e.charAt(0)
               .toLowerCase() + e.slice(1)] = i, t.style['webkit' + e] = i, t.style['moz' + e] = i, t.style['ms' + e] = i, t.style['o' + e] = i;
    },
  ...
  t.prototype.init = function() {
    this.index = 0, this.lastAnimation = 0, this.build(), this.bindEvents(), this.makeActive(this.index), 'function' == typeof this.settings.afterLoad && this.settings.afterLoad(this.index);
  },
    ...
    t.prototype.bindEvents = function() {
      ...
      if (this.settings.pagination) {
        for (var e = document.querySelectorAll('.slide-navigation li a'), i = 0; i < e.length; i++) !function(s) {
          e[i].addEventListener('click', function(e) {
            t.index = s, t.move(t.index), e.preventDefault();
          });
        }(i);
      }
    ...
    t.prototype.makeActive = function(t) {
      for (var i = document.querySelectorAll('.slide-navigation li a'), s = 0; s < this.sections.length; s++) e.removeClass(this.sections[s], 'is-active'), e.removeClass(i[s], 'is-active');
      e.addClass(this.sections[t], 'is-active'), e.addClass(i[t], 'is-active');
    },
    t.prototype.move = function(t) {
      ...
      this.el.addEventListener('transitionend', s), this.index = t, this.makeActive(t);
    },
    ...
    t.prototype.enableTouch = function(t) {
      ...
      t.addEventListener('touchstart', function(t) {
        ...
        s = t.changedTouches[0].pageY, n = s - i, o - Math.abs(e.lastAnimation) < e.settings.animationDuration || (n < 0 && Math.abs(n) > e.settings.touchLimit ? e.moveDown() : n > 0 && Math.abs(n) > e.settings.touchLimit && e.moveUp(), e.lastAnimation = o);
      });
    },
    t.prototype.mousewheel = function(t) {
      var e = (new Date).getTime(), i = t.wheelDelta || -t.detail;
