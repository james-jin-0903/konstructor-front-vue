            ...
            .detail-page__stats
              .detail-page__stats-list
                .detail-page__stats-list-item
                  .stats-name Цена:
                  .stats-value.stats-value--big.stats-value--discount(data-discount="$1499.99") $999.99
                .detail-page__stats-list-item
                  .stats-name Экономия:
                  .stats-value.stats-value--extra-info(data-extra-info="-25%") $500
                .detail-page__stats-list-item
                  .stats-name Локация:
...
<script>
  ...
  const PAGE_NAME = 'Название услуги';
