...
const PAGE_NAME = 'Название подпроекта';
export default {
  name: 'Projects',
  components: {
    Breadcrumbs,
      ...
      if (type === 'newTask') {
        localStorage.setItem(
          ...
          JSON.stringify({
            ...
            subproject_id: 'test_id',
            subproject_name: 'Название подпроекта',
          })
        );
